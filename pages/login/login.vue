<template>
	...
	<view>
		...
		<!-- 引入背景图 -->
		<image class="loginhead" src="../../static/common/loginhead.png" mode="aspectFill" lazy-load=""></image>
		<!-- 输入框 + 按钮 -->
		<view class="body">
			...
			<template v-if="!status">
				...
				<view class="login-input-box">
					...
					<view class="forget u-f-ajc login-font-color">
						忘记密码?
					</view>
				</view>
			</template>
			...
			<button class="user-set-btn" type="primary" :loading="loading" :class="{'user-set-btn-disable':disabled}" @tap="submit"
